...
def resnet_arg_scope(is_training= True, weight_decay=0.001, batch_norm_decay=0.997, 
...
def resnet_v2(inputs, blocks, num_classes=None, global_pool = True,include_root_block=True,
    ...
    with tf.variable_scope(scope, 'resnet_v2', [inputs], reuse = reuse) as sc:
        ...
        with slim.arg_scope([slim.conv2d, bottleneck, stack_blocks_dense], outputs_collections=end_points_collection):
            net = inputs
            # conv2d and max_pool with input
...
def resnet_v2_50(inputs, num_classes=None, global_pool=True, reuse=None, scope='resnet_v2_50'):
    blocks = [
        ...
        Block('block4', bottleneck, [(2048, 512, 1)] * 3 + [(2048, 512, 2)])]
...
sess.run(init)
num_batches = 100
time_tensorflow_run(sess, net, "Forword")
